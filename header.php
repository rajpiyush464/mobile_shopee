    ...
    <nav class="navbar navbar-expand-lg navbar-dark color-second-bg">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav m-auto font-rubik">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#special">Special Price</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                <a href="https://mail.google.com/mail/u/1/#inbox?compose=DmwnWrRsphHBRVfWjvDWNjKcFghmpWgVTKZcGScfvtkGzjBvWjWZzQXtmLTTSHbGKQMMSmphNwtq" target="_blank" class="nav-link">Contact us</a>
                </li>
            </ul>
